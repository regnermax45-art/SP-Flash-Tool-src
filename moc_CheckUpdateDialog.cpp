...
#include <memory>
#include "UI/src/CheckUpdateDialog.h"
...
QT_MOC_LITERAL(1, 18, 19), // "signal_check_finish"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 7), // "bUpdate"
QT_MOC_LITERAL(4, 47, 24) // "on_pushButton_ok_clicked"

    },
    "CheckUpdateDialog\0signal_check_finish\0"
    "\0bUpdate\0on_pushButton_ok_clicked"
};
...
void CheckUpdateDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CheckUpdateDialog::*)(const bool & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CheckUpdateDialog::signal_check_finish)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CheckUpdateDialog::signal_check_finish(const bool & _t1)
{
